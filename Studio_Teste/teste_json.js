...
//Função responsavél por verificar se o Estado digitado pelo usuario é valido.
function validaUF() {
  ...
  while (x<num_estados){
    if (sUf === UFs[x].ID){
      alert(UFs[x].nome_por_extenso + ' | ' + UFs[x].sigla + ' | ' + UFs[x].capital + ' | ' + UFs[x].regiao)
      ufValida == true;				
      break
    } 
    else {
